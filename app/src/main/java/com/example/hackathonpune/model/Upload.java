            ...
            public void run() {
                try {
                    ...
                    if(responseCode == HttpURLConnection.HTTP_OK){
                        ...
                        if(user!=null) {
                            Double size=(new Sizeofbase64()).calcBase64SizeInKBytes(server_response);
                            ImageUploadInfo imageUploadInfo = new ImageUploadInfo(user.getEmail(), server_response,size);

                            myRef.push().setValue(imageUploadInfo);
                        }
